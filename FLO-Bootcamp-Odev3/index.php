...
<form action="ekle.php" method="post" style="text-align:center;">
    <strong>Adınız Soyadınız:</strong><br>
     <input style="text-align:center" type="text" name="adsoyad" value="" size="30" required>
    <br><br>
    <strong>Telefon Numarınız:</strong> <br>
    <input style="text-align:center" type="tel" name="telefon" value="" size="30" placeholder="0 5** *** ** **" required>
    <br><br>
