...
<head>
  ...
  <title>Burs Veren Takip Yönetim Paneli</title>
...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      ...
      <div class="card">
            <div class="card-body">
              <h5 class="card-title">Burs Veren Ekle</h5>
              ...
              <div class="col-md-6">
                ...
                <div class="col-12">
                  <div class="form-floating">
                  <input type="number" name="bagismiktar" class="form-control" placeholder="Bağış Miktarı" required>
                    <label >Bağış Miktarı</label>
                  </div>
                </div>
                <div class="text-center">
                  <button type="submit" class="btn btn-primary">Burs Veren Ekle</button>
...
<div class="card">
            <div class="card-body">
              <h5 class="card-title">Burs Verenler</h5>

              <form action="bursveren" method="post">
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Burs Veren Ara</label>
                  <div class="col-sm-10">
              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Bağış Miktarı(TL)</th>
                ...
                <tbody>
                  ...
                  if (isset($_POST["arama"]) & $_POST["arama"] != "") {
                    $sorgu = $baglan->prepare("select * from bursveren where concat(ad,soyad,telefon,mail) like '%".$search."%' ");
                    $sorgu->execute();
                    while ($satir = $sorgu->fetchObject()){
                      echo "<tr>
                              ...
                              <td>$satir->mail</td>
                              <td>$satir->bagis</td>
                              <td><a href='bursveren.php?id=$satir->id'>Sil</a></td> 
                            </tr>";
                    }
                  } else {
                  ...
                  ?>
                  <button type="button" class="btn btn-light"><a href="csvindir.php?id=bursveren">
