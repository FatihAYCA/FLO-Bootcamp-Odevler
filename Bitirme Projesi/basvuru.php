...
<head>
  ...
  <title>Burs Başvuru Sayfası</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Burs başvurunuzun geçerli olması için bütün bilgileri eksiksiz ve doğru doldurunuz.</h1>
    </div>
    ...
    <section class="section dashboard">
      ...
      <div class="card">
            <div class="card-body">
              <h5 class="card-title">Burs Başvuru Formu</h5>
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="text" name="mail" class="form-control" placeholder="Mail Adresiniz" required>
                    <label for="floatingPassword">Mail Adresiniz</label>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-floating">
                  <input type="text" name="neden" class="form-control" placeholder="Başvuru Nedeniniz" required>
